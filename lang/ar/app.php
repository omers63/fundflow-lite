...
return [
    ...
    */
    ...
    'loan.field.member_portion_hint' => 'جزء أصل القرض المسحوب من صندوق العضو عند الصرف (الأصغر بين رصيد الصندوق والمبلغ المعتمد). يُكمّل مع «حصة الصندوق الرئيسي» ليعادلا المبلغ المعتمد.',
    'loan.field.master_portion_hint' => 'جزء أصل القرض المموّل من صندوق الأمانة الجماعي. تُحتسب الأقساط المُرحَّلة لصندوق الأمانة ضمن «المُسدَّد (مسار الصندوق)» حتى يُسترد هذا المبلغ (مسار إخلاء طرف الكفيل).',
    'loan.field.repaid_to_master_hint' => 'مجموع أصل الأقساط المُرحَّل لصندوق الأمانة لهذا القرض. قارِنها بـ «حصة الصندوق الرئيسي» لمعرفة كم تبقّى من أصل المُموّل جماعياً.',
    'loan.table.remaining_balance' => 'الرصيد المتبقي',
    'loan.table.remaining_balance_hint' => 'مجموع الأصل المجدول على الأقساط المعلّقة والمتأخرة (بالمثل مجمع صفحة الأقساط).',
