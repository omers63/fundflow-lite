                ...
                ->schema([
                    ...
                    Section::make(__('Repayment Rules'))->schema([
                        Forms\Components\TextInput::make('settlement_threshold_pct')
                            ...
                            ->helperText(__('Loan is settled when master fund is repaid AND member\'s fund account reaches this % of the loan amount.')),
                        Forms\Components\TextInput::make('default_grace_cycles')
                            ...
                            ->helperText(__('Number of missed cycles that trigger a warning to borrower before holding guarantor liable.')),
                    ])->columns(2),
                ])
