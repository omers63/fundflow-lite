...
class ContributionCycleSettingsPage extends Page
{
    ...
    {
        return __('Contribution & repayment cycles');
    }
                    ...
                    Section::make(__('Cycle boundaries'))
                        ...
                        ->schema([
                            Forms\Components\TextInput::make('cycle_start_day')
                                ...
                                ->default(6)
                                ->helperText(
                                    __('Example: 6 → June cycle runs 6 Jun through 5 Jul; payment is due by end of 5 Jul. Limited to 28 to keep February consistent.')
                                ),
                        ]),
                ])
