...
/**
 * Filament's default relation tabs use Livewire $set('activeRelationManager') with #[Url].
 * On member View/Edit pages that often fails to update the DOM; Alpine-only tabs switch reliably.
 */
trait UsesAlpineRelationManagerTabs
{
