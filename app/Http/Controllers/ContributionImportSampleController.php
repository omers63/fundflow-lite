...
class ContributionImportSampleController extends Controller
{
    public function __invoke(): StreamedResponse
    {
        ...
        $rows = [
            ['101', '', '', '', '1', '2026', '500', '2026-01-05 09:15:00', 'DEP-1001', 'Standard contribution-only row', '0', '', 'cash_account', ''],
            ['', 'M-000102', '', '', 'February', '2026', '1000', '2026-02-06', 'DEP-1002', 'Repayment-first auto allocation if feature enabled', '0', '', '', '0'],
            ['', '', '', 'John Kamau', 'Mar', '2026', '1500', '2026-03-08 12:30', 'DEP-1003', 'Matched by member name', '0', '', '', ''],
            ['', 'M-000104', '', '', '4', '2026', '2000', '2026-04-07', 'DEP-1004', 'May create unapplied credit remainder based on settings', '0', '', '', '0'],
            ['105', '', '', '', 'May', '2026', '2500', '2026-05-10', 'DEP-1005', 'Late by policy', '1', '25', 'online', ''],
            ['', '', '', 'Amina Yusuf', '6', '2026', '3000', '2026-06-12', 'DEP-1006', 'Strict-mode override row', '1', '', '', '1'],
            ['107', '', '', '', 'July', '2025', '500', '2025-07-05', 'DEP-0901', '', '0', '', 'cash_account', ''],
            ['', 'M-000108', '', '', '8', '2025', '1000', '2025-08-06', 'DEP-0902', '', '0', '', 'bank_transfer', ''],
            ['', '', '1100223344', '', 'September', '2025', '1500', '2025-09-07 10:00', 'DEP-0903', 'Matched by national ID', '0', '', '', ''],
            ...
            ['', 'M-000112', '', '', '12', '2025', '3000', '2025-12-05', 'DEP-0906', '', '0', '', '', '0'],
