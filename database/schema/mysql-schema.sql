...
CREATE TABLE `contributions` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `contributions_member_id_month_year_unique` (`member_id`,`month`,`year`),
...
CREATE TABLE `loans` (
  ...
  `installments_count` tinyint unsigned NOT NULL DEFAULT '12',
...
CREATE TABLE `members` (
  ...
  `status` enum('active','suspended','delinquent') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `membership_applications` (
  ...
  `next_of_kin_name` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `next_of_kin_phone` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `membership_applications_user_id_foreign` (`user_id`),
  KEY `membership_applications_reviewed_by_foreign` (`reviewed_by`),
  CONSTRAINT `membership_applications_reviewed_by_foreign` FOREIGN KEY (`reviewed_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `membership_applications_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `notification_logs` (
  ...
  `channel` enum('mail','sms','whatsapp') COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (4,'2025_01_01_000010_create_membership_applications_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (5,'2025_01_01_000020_create_members_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (6,'2025_01_01_000030_create_contributions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (7,'2025_01_01_000040_create_loans_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (8,'2025_01_01_000050_create_loan_installments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (9,'2025_01_01_000060_create_monthly_statements_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (10,'2025_01_01_000070_create_notification_logs_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (11,'2026_03_31_043819_create_permission_tables',2);
