...
<div class="space-y-6">
    ...
    <div class="rounded-xl bg-primary-50 dark:bg-primary-900/20 ring-1 ring-primary-200 dark:ring-primary-700 p-5">
        <div class="flex items-start gap-3">
            ...
            <div>
                <p class="text-sm font-semibold text-primary-800 dark:text-primary-300">How can we help?</p>
                <p class="text-sm text-primary-700 dark:text-primary-400 mt-1">
                    Use the <strong>Submit Request</strong> button above to send a message to the fund administrators.
                    You can inquire about your account, request a cash deposit, ask about your loan, or raise a complaint.
                    Admins will respond via the messaging system.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        @foreach([
            ...
            ['icon' => 'heroicon-o-calculator', 'title' => 'Contribution Query', 'desc' => 'Questions about your monthly contributions', 'color' => 'amber'],
            ['icon' => 'heroicon-o-chart-bar', 'title' => 'Balance / Account', 'desc' => 'Queries about your balances or ledger', 'color' => 'purple'],
            ['icon' => 'heroicon-o-exclamation-triangle', 'title' => 'Complaint', 'desc' => 'Raise a concern or formal complaint', 'color' => 'red'],
            ['icon' => 'heroicon-o-question-mark-circle', 'title' => 'General Inquiry', 'desc' => 'Any other question or request', 'color' => 'gray'],
        ] as $cat)
    ...
    <div class="rounded-xl bg-gray-50 dark:bg-gray-800 ring-1 ring-gray-200 dark:ring-gray-700 p-4 text-center">
        <p class="text-sm text-gray-600 dark:text-gray-400">
            ...
            For urgent matters, contact your fund administrator directly.
        </p>
    </div>
