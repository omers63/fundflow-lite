...
<div class="w-full space-y-4">
    <div class="grid grid-cols-1 gap-4 xl:grid-cols-3">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-gray-900/60">
            <p class="text-xs uppercase tracking-[0.14em] text-gray-500 dark:text-gray-400">{{ __('Posting Coverage') }}</p>
    ...
    <div class="grid grid-cols-1 gap-4 xl:grid-cols-3">
        <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-gray-900/60">
            <p class="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">{{ __('Pending Queue') }}</p>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-gray-900/60">
            <p class="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">{{ __('Loan Reconciliation') }}</p>
            <div class="mt-3 space-y-3">
                <div class="rounded-xl bg-emerald-50 p-3 dark:bg-emerald-500/10">
                    <p class="text-xs text-emerald-700 dark:text-emerald-300">{{ __('Linked debit postings') }}</p>
                ...
                <div class="rounded-xl bg-amber-50 p-3 dark:bg-amber-500/10">
                    <p class="text-xs text-amber-700 dark:text-amber-300">{{ __('Needs link') }}</p>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-gray-900/60">
            <p class="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">{{ __('Posted Activity (Last 7 Days)') }}</p>
