...
<div class="rounded-2xl bg-white dark:bg-gray-800 ring-1 ring-gray-200 dark:ring-gray-700 shadow-sm overflow-hidden h-full flex flex-col">
    ...
    <div class="flex flex-col gap-4 p-5 flex-1">
        ...
        {{-- Doughnut chart --}}
        <div class="flex-1 flex items-center justify-center" style="min-height: 180px; max-height: 220px;"
            wire:ignore
            x-data="{
                chart: null,
                init() {
        ...
        <div class="space-y-1.5">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-2 min-w-0">
                    <span class="flex-shrink-0 w-2.5 h-2.5 rounded-full" style="background: {{ $item['color'] }}"></span>
