    ...
    <div class="bg-white dark:bg-gray-900 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-100 dark:divide-gray-800">
        ...
        <div class="p-5 space-y-3">
            ...
            <dl class="space-y-2">
                <div class="flex items-start gap-2">
                    <dt class="text-xs text-gray-400 dark:text-gray-500 w-20 flex-shrink-0 pt-0.5">{{ __('Email') }}</dt>
                ...
                <div class="flex items-start gap-2">
                    <dt class="text-xs text-gray-400 dark:text-gray-500 w-20 flex-shrink-0 pt-0.5">{{ __('Joined') }}</dt>
                    <dd class="text-sm text-gray-900 dark:text-gray-100 font-medium">{{ $d['joined_at'] }}</dd>
                </div>
                @if($d['dob'])
                <div class="flex items-start gap-2">
                    <dt class="text-xs text-gray-400 dark:text-gray-500 w-20 flex-shrink-0 pt-0.5">{{ __('Date of Birth') }}</dt>
                ...
                @if($d['national_id'])
                <div class="flex items-start gap-2">
                    <dt class="text-xs text-gray-400 dark:text-gray-500 w-20 flex-shrink-0 pt-0.5">{{ __('National ID') }}</dt>
        ...
        <div class="p-5 space-y-3">
            ...
            <dl class="space-y-2">
                @if($d['occupation'])
                <div class="flex items-start gap-2">
                    <dt class="text-xs text-gray-400 dark:text-gray-500 w-24 flex-shrink-0 pt-0.5">{{ __('Occupation') }}</dt>
                    <dd class="text-sm text-gray-900 dark:text-gray-100 font-medium">{{ $d['occupation'] }}</dd>
                </div>
                @endif
                @if($d['employer'])
                <div class="flex items-start gap-2">
                    <dt class="text-xs text-gray-400 dark:text-gray-500 w-24 flex-shrink-0 pt-0.5">{{ __('Employer') }}</dt>
            ...
            <div class="pt-3 border-t border-gray-100 dark:border-gray-800">
                ...
                <dl class="space-y-1">
                    ...
                    <div class="flex items-start gap-2">
                        <dt class="text-xs text-gray-400 dark:text-gray-500 w-12 flex-shrink-0 pt-0.5">{{ __('Name') }}</dt>
        ...
        <div class="p-5 space-y-3">
            ...
            <div class="bg-gray-50 dark:bg-gray-800 rounded-xl p-3">
                ...
                <p class="text-xs text-gray-400 dark:text-gray-500 mt-1.5">{{ __('Contribution records ÷ months since joined — not the same as payments flagged late on the contribution.') }}</p>
            </div>
            ...
            <div class="flex items-center gap-2 text-sm">
                @if($d['is_loan_eligible_age'])
                    ...
                    <span class="text-gray-700 dark:text-gray-300">{{ __('Loan-eligible since :date', ['date' => $d['loan_eligible_date']]) }}</span>
                @else
                    ...
                    <span class="text-gray-500 dark:text-gray-400">{{ __('Loan eligible :date', ['date' => $d['loan_eligible_date']]) }}</span>
                @endif
            </div>
