            ...
            <div class="p-6 sm:p-8">
                ...
                <div class="mb-6 p-4 bg-amber-50 border border-amber-200 rounded-2xl flex gap-3">
                    ...
                    <div>
                        ...
                        <a href="{{ route('application.status') }}" class="text-amber-600 text-xs font-medium underline mt-1 inline-block">{{ __('Check detailed status') }}</a>
                    </div>
                </div>
                @endif
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-slate-500">
                        {{ __('Not a member yet?') }}
                        <a href="{{ route('apply') }}" class="text-blue-600 font-semibold hover:underline">{{ __('Apply for membership') }}</a>
                    </p>
                    <p class="text-sm text-slate-500 mt-2">
                        {{ __('Applied already?') }}
                        <a href="{{ route('application.status') }}" class="text-indigo-600 font-semibold hover:underline">{{ __('Check your status') }}</a>
                    </p>
                </div>
            </div>
        </div>
