<div>
    {{-- Hero Section --}}
    <section class="relative overflow-hidden bg-gradient-to-br from-slate-900 via-emerald-950 to-teal-900 text-white">
        <div class="absolute inset-0 opacity-10">
            <div class="absolute top-20 left-10 w-72 h-72 bg-emerald-400 rounded-full blur-3xl"></div>
            <div class="absolute bottom-10 right-10 w-96 h-96 bg-teal-400 rounded-full blur-3xl"></div>
        </div>
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-28 text-center">
            <div class="inline-flex items-center px-4 py-2 rounded-full bg-emerald-500/20 border border-emerald-500/30 text-emerald-300 text-sm font-medium mb-8">
            ...
            <h1 class="text-5xl md:text-6xl font-extrabold leading-tight mb-6">
                ...
                <span class="block text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-300">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('apply') }}" class="bg-emerald-500 hover:bg-emerald-400 text-white font-bold px-8 py-4 rounded-2xl transition-all shadow-lg hover:shadow-emerald-500/30 text-lg">
    ...
    <section class="py-16 bg-white border-b border-slate-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="text-center p-8 rounded-2xl bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-100">
                    <div class="text-4xl font-extrabold text-emerald-600 mb-2">{{ number_format($stats['members']) }}</div>
                ...
                <div class="text-center p-8 rounded-2xl bg-gradient-to-br from-teal-50 to-cyan-50 border border-teal-100">
                    <div class="text-4xl font-extrabold text-teal-600 mb-2">{{ number_format($stats['active_loans']) }}</div>
    ...
    <section id="features" class="py-24 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-white rounded-2xl p-8 border border-slate-200 hover:border-emerald-300 hover:shadow-lg transition-all group">
                ...
                <div class="bg-white rounded-2xl p-8 border border-slate-200 hover:border-teal-300 hover:shadow-lg transition-all group">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-4 gap-8">
                ...
                <div class="text-center relative">
                    <div class="w-16 h-16 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl flex items-center justify-center text-white text-2xl font-extrabold mx-auto mb-5 shadow-lg">
                        {{ $step['step'] }}
                    </div>
    ...
    <section class="py-20 bg-gradient-to-br from-emerald-600 to-teal-700 text-white">
        <div class="max-w-4xl mx-auto px-4 text-center">
            ...
            <p class="text-emerald-100 text-lg mb-8">Apply for membership today and start building a stronger financial future together.</p>
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('apply') }}" class="bg-white text-emerald-700 font-bold px-8 py-4 rounded-2xl hover:bg-emerald-50 transition-all shadow-lg text-lg">
                    Apply for Membership
                </a>
                <a href="{{ route('application.status') }}" class="bg-emerald-500/30 hover:bg-emerald-500/50 border border-white/30 text-white font-semibold px-8 py-4 rounded-2xl transition-all text-lg">
