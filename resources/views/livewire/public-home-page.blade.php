        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="text-center p-8 rounded-2xl bg-gradient-to-br from-amber-50 to-yellow-50 border border-amber-100">
                    <div class="text-4xl font-extrabold text-amber-600 mb-2">{{ __('SAR') }} {{ number_format($stats['total_contributions'], 0) }}</div>
    ...
    <section id="features" class="py-24 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <p class="text-lg text-slate-500 max-w-2xl mx-auto">{{ __('A complete family fund management solution with powerful tools for members and administrators.') }}</p>
            </div>
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-white rounded-2xl p-8 border border-slate-200 hover:border-blue-300 hover:shadow-lg transition-all group">
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed">{{ __('Easy application process, online form submission, and admin approval workflow with instant notifications.') }}</p>
                </div>
                <div class="bg-white rounded-2xl p-8 border border-slate-200 hover:border-sky-300 hover:shadow-lg transition-all group">
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed">{{ __('Track member contributions by month and year, with automatic balance calculations and statements.') }}</p>
                </div>
                <div class="bg-white rounded-2xl p-8 border border-slate-200 hover:border-indigo-300 hover:shadow-lg transition-all group">
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed">{{ __('Download detailed PDF statements showing contributions, loan repayments, and account balance.') }}</p>
                </div>
                <div class="bg-white rounded-2xl p-8 border border-slate-200 hover:border-purple-300 hover:shadow-lg transition-all group">
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed">{{ __('Apply for zero-interest loans with flexible repayment schedules and eligibility-based approval.') }}</p>
                </div>
                <div class="bg-white rounded-2xl p-8 border border-slate-200 hover:border-amber-300 hover:shadow-lg transition-all group">
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed">{{ __('Receive real-time email, SMS, and WhatsApp alerts for approvals, loans, and payment reminders.') }}</p>
                </div>
                <div class="bg-white rounded-2xl p-8 border border-slate-200 hover:border-rose-300 hover:shadow-lg transition-all group">
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed">{{ __('Comprehensive oversight with statistics, delinquency handling, and bulk management tools.') }}</p>
                </div>
            </div>
        </div>
    </section>
