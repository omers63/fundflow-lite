<div class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 py-8 sm:py-12 px-4">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-8 text-center">
            <h1 class="text-2xl sm:text-3xl font-bold text-slate-800 mb-2">{{ __('Apply for Membership') }}</h1>
            <p class="text-slate-500">{{ __('Complete the form below to join the FundFlow family fund.') }}</p>
            <a
            ...
            <div class="p-5 sm:p-8">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <input wire:model="email" type="email" placeholder="{{ __('you@example.com') }}" class="w-full px-4 py-3 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 @error('email') border-red-400 @enderror">
