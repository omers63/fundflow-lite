            ...
            <div class="p-8">
                <form wire:submit="check" class="space-y-5">
                    <div>
                        ...
                        <input wire:model="email" type="email" placeholder="your@email.com" class="w-full px-4 py-3 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 @error('email') border-red-400 @enderror">
                ...
                <div class="mt-8 pt-6 border-t border-slate-100">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="p-5 bg-blue-50 border border-blue-200 rounded-2xl">
                            <div class="flex items-center gap-3 mb-3">
                                ...
                                <div>
                                    <p class="font-bold text-blue-900">Approved!</p>
                                    <p class="text-xs text-blue-700">Applicant: {{ $result['name'] }}</p>
                                </div>
                            </div>
                            <dl class="space-y-1 text-sm">
                                <div class="flex justify-between"><dt class="text-slate-500">Submitted</dt><dd class="font-medium text-slate-700">{{ $result['submitted_at'] }}</dd></div>
                            ...
                            <div class="mt-3 pt-3 border-t border-blue-200">
                                <a href="{{ route('login') }}" class="text-sm font-bold text-blue-800 hover:underline">Sign in to your account →</a>
                            </div>
                        </div>
                        @else
                    ...
                    <div class="p-5 bg-slate-50 border border-slate-200 rounded-2xl text-center">
                        ...
                        <a href="{{ route('apply') }}" class="text-blue-600 text-sm font-semibold hover:underline mt-2 inline-block">Apply for membership →</a>
                    </div>
                    @endif
                </div>
                @endif
